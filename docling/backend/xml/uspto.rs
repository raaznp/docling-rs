...
impl DocumentBackend for UsptoBacked {
...
impl DeclarativeBackend for UsptoBacked {
        ...
        loop {
            match reader.read_event_into(&mut buf) {
                Ok(Event::Start(ref e)) => {
                    in_tag = matches!(e.name().as_ref(), b"p" | b"heading" | b"abstract");
                }
