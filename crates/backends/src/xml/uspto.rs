...
/// USPTO Patent XML backend.
/// Parses USPTO patent XML documents into DoclingDocument.
/// Mirrors `docling/backend/xml/uspto_backend.py`.
...
impl DocumentBackend for UsptoBackend {
